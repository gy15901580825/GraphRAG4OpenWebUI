...
async def setup_llm_and_embedder():
    ...
    api_key = os.environ.get("GRAPHRAG_API_KEY", "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")
...
async def list_models():
    ...
    models = [
        {"id": "local-search:latest", "object": "model", "created": current_time - 100000, "owned_by": "graphrag"},
...
UPLOAD_DIR = f"{Path(__file__).parent}/input"
...
def upload_file(file: UploadFile = File(...)):
    ...
    try:
        ...
        file = Files.insert_new_file(
            'a4138f2e-a47a-4db6-a3c3-d0ccebb8348c',
            FileForm(
                **{
                    "id": id,
                    "filename": filename,
...
@app.get("/v1/files/", response_model=list[FileModel])
